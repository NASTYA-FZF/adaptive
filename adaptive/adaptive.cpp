...
// adaptive.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CadaptiveApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CadaptiveApp

CadaptiveApp::CadaptiveApp()
{
...
// Единственный объект CadaptiveApp

CadaptiveApp theApp;


// Инициализация CadaptiveApp

BOOL CadaptiveApp::InitInstance()
{
